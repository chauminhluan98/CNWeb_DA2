<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/admin/comic_books/create')); ?>" method="post">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="comic_book_title" value="<?php echo e(old('comic_book_title')); ?>" required autocomplete="comic_book_title" />
...
unset($__errorArgs, $__bag); ?>" name="comic_cover" value="<?php echo e(old('comic_cover')); ?>" required autocomplete="comic_cover" />
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group">
					...
					<textarea id="comic_book_excerpt" class="form-control <?php $__errorArgs = ['comic_book_excerpt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="comic_book_excerpt" height="300" ><?php echo e(old('comic_book_excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-check mb-3">
					<input class="form-check-input" type="checkbox" id="completed" name="completed" <?php echo e(old('completed') ? 'checked' : ''); ?> />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\MangaVui.net\resources\views/admin/comic_books/create.blade.php ENDPATH**/ ?>