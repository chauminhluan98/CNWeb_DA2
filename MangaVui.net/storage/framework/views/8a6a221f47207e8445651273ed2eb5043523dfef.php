<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/admin/episodes/create')); ?>" method="post">
				<?php echo csrf_field(); ?>
				<input type="hidden" id="comic_book_id" name="comic_book_id" value="<?php echo e($id); ?>" />
...
unset($__errorArgs, $__bag); ?>" name="episode_title" value="<?php echo e(old('episode_title')); ?>" required autocomplete="episode_title" />
...
unset($__errorArgs, $__bag); ?>" name="episode_content" required><?php echo e(old('episode_content')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\MangaVui.net\resources\views/admin/episodes/create.blade.php ENDPATH**/ ?>