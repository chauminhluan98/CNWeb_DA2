...
unset($__errorArgs, $__bag); ?>" name="post_excerpt"><?php echo e(old('post_excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="post_content" required><?php echo e(old('post_content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-check mb-3">
					<input class="form-check-input" type="checkbox" id="comment_status" name="comment_status" <?php echo e(old('comment_status') ? 'checked' : ''); ?> />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\inews_v3.0\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>