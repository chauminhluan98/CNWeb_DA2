...
<body>
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-warning sticky-top shadow-sm" style="background-color:#87cefa;">
			<a class="navbar-brand" href="<?php echo e(url('/')); ?>">
				<img src="<?php echo e(asset('public/images/WebIcon.png')); ?>" width="30" height="30" class="d-inline-block align-top" alt="" />
					...
					<?php else: ?>
						<?php if(Auth::user()->privilege == "admin"): ?>
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownManager">
									<a class="dropdown-item" href="<?php echo e(url('/admin/categories')); ?>"><i class="fas fa-fw fa-list"></i> Thể loại</a>
									<a class="dropdown-item" href="<?php echo e(url('/admin/comic_books')); ?>"><i class="fas fa-fw fa-newspaper"></i> Truyện tranh</a>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownUser">
								<a class="dropdown-item" href="<?php echo e(url('/admin/comic_books/create')); ?>"><i class="fas fa-fw fa-plus"></i> Thêm truyện mới</a>
								<a class="dropdown-item" href="<?php echo e(url('/admin/comic_books/user')); ?>"><i class="fas fa-fw fa-clone"></i> Truyện của tôi</a>
...
</html><?php /**PATH D:\wamp64\www\MangaVui.net\resources\views/layouts/app.blade.php ENDPATH**/ ?>