						...
						<tr>
							...
							<?php if($user == 'admin'): ?>
								<?php if($value->episode_status == 1): ?>
									<a href="<?php echo e(url('/admin/episodes/status/' . $value->id)); ?>"><i class="fas fa-check"></i></a>
								<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\inews_v3.0\resources\views/admin/episodes/index.blade.php ENDPATH**/ ?>