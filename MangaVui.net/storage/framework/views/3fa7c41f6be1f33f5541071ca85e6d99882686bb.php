						...
						<tr>
							...
							<td class="text-center">
								<?php if($value->post_status == 1): ?>
									<a href="<?php echo e(url('/admin/posts/status/' . $value->id)); ?>"><i class="fas fa-check"></i></a>
								<?php else: ?>
									<a href="<?php echo e(url('/admin/posts/status/' . $value->id)); ?>"><i class="fas fa-ban text-danger"></i></a>
								<?php endif; ?>
							</td>
							<td class="text-center">
								<?php if($value->comment_status == 1): ?>
									<a href="<?php echo e(url('/admin/comments/status/' . $value->id)); ?>"><i class="fas fa-check"></i></a>
								<?php else: ?>
									<a href="<?php echo e(url('/admin/comments/status/' . $value->id)); ?>"><i class="fas fa-ban text-danger"></i></a>
								<?php endif; ?>
							</td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\inews_v3.0\resources\views/admin/posts/index.blade.php ENDPATH**/ ?>