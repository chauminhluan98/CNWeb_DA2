<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/admin/users/edit')); ?>" method="post">
				<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e($user->username); ?>" required autocomplete="username" />
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group">
					...
					<select class="custom-select form-control <?php $__errorArgs = ['privilege'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\Wamp64\www\inews_v1.0\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>